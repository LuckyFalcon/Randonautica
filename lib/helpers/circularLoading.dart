...
class circularLoading extends StatefulWidget {
  ...
  circularLoading({this.color1 = Colors.deepOrangeAccent, this.color2 = Colors.yellow, this.color3 = Colors.lightGreen});

  @override
  _circularLoadingState createState() => _circularLoadingState();
}

class _circularLoadingState extends State<circularLoading> with TickerProviderStateMixin {
