...
class ComScireButton extends StatefulWidget {
  Function callback;

  ComScireButton(this.callback);


  State<StatefulWidget> createState() => new _ComScireButton();
}

class _ComScireButton extends State<ComScireButton> {
    ...
    return SizedBox(
      ...
      child: new ButtonTheme(
        ...
        child: RaisedButton(
          ...
          child: Text(
              AppLocalizations.of(context).translate('ComScire').toUpperCase(),
