...
class AttractorButton extends StatefulWidget {
  Function callback;

  AttractorButton(this.callback);


  State<StatefulWidget> createState() => new _AttractorButton();
}

class _AttractorButton extends State<AttractorButton> {
