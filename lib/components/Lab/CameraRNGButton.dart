...
class CameraRNGButton extends StatefulWidget {
  Function callback;

  CameraRNGButton(this.callback);

  State<StatefulWidget> createState() => new _CameraRNGButton();
}

class _CameraRNGButton extends State<CameraRNGButton> {
